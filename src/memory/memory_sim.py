...
class GlobalMemory:
    ...
    occupancy: dict[ArtifactId, int] = field(
    ...
    def evict(self, size):
        ...
        while evicted_size < size:
            ...
            req_size = (
                GlobalMemory.num_blocks(artifact.size, self.block_size)
                * self.block_size
            )
    ...
    def get_all_artifacts(self) -> list[tuple[ArtifactId, Artifact]]:
        swap_artifacts = self.swap.get_all_artifacts()
        memory_artifacts = list(self.store.items())
