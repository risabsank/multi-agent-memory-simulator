...
class EventType(str, Enum):
    ...
    EV_SUMMARIZE_REQ = "EV_SUMMARIZE_REQ"
    EV_SUMMARIZE_COMMIT = "EV_SUMMARIZE_COMMIT"
    EV_CONFLICT_CHECK = "EV_CONFLICT_CHECK" # semantic validation modeled as deterministic event
